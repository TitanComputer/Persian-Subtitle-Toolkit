...
dialog_hyphen_fix_list = [
    ...
    # Direct fix for two-line dialogs where hyphens are at the end without spaces (supports both \n and \r\n)
    (
        re.compile(r"""^([^\r\n]+?)-\r?\n([^\r\n]+?)-$""", re.MULTILINE),
        r"""- \1\n- \2""",
        True,
    ),
    # Direct fix if only line 1 has trailing hyphen
    (
        re.compile(r"""^([^\r\n]+?)-\r?\n([^\r\n]+?)$""", re.MULTILINE),
        r"""- \1\n\2""",
        True,
    ),
    # Direct fix if only line 2 has trailing hyphen
    (
        re.compile(r"""^([^\r\n]+?)\r?\n([^\r\n]+?)-$""", re.MULTILINE),
        r"""\1\n- \2""",
        True,
    ),
    # NEW: Move trailing dialog hyphen of the first line to the front
    (
        re.compile(r"""\A(\<[^<>]+\>)*(?!\s*\-)([^\r\n]+?)(\s*)\-(\<[^<>]+\>)*(\r?\n)"""),
        r"""\g<1>- \g<2>\g<4>\g<5>""",
        True,
    ),
    # NEW: Move trailing dialog hyphen of the second line to the front
    (
        re.compile(r"""(\r?\n)(\<[^<>]+\>)*(?!\s*\-)([^\r\n]+?)(\s*)\-(\<[^<>]+\>)*\z"""),
        r"""\g<1>\g<2>- \g<3>\g<5>""",
        True,
    ),
    # FIXED: Re-aligned replacement strings to format hyphens at the start "- text" instead of pushing to the end.
    (
        re.compile(r"""\A([،\.\!\s\"]*)(\-)(.*)(\r?\n)([،\.\!\s\"]*)(\-)(.*)\z"""),
        r"""\g<1>\g<2> \g<3>\g<4>\g<5>\g<6> \g<7>""",
        True,
    ),
    (
        re.compile(
    ...
    (
        ...
        r"""\g<1>\g<4> \g<2>\g<3>\g<5>\g<6>\g<7>\g<9> \g<8>\g<10>\g<11>""",
        True,
    ),
    (
        re.compile(
        ...
        r"""\g<1>\g<3> \g<2>\g<4>\g<5>\g<6>\g<7>\g<10> \g<8>\g<9>\g<11>""",
        True,
    ),
    (
        re.compile(
        ...
        r"""\g<1>\g<4> \g<2>\g<3>\g<5>\g<6>\g<7>- \g<8>\g<9>\g<10>\g<11>""",
        True,
    ),
    (
        re.compile(
        ...
        r"""\g<1>- \g<2>\g<3>\g<4>\g<5>\g<6>\g<7>\g<10> \g<8>\g<9>\g<11>""",
        True,
    ),
    (re.compile(r"""\A([\s\-]+)(\<[^\u0600-\u06FF]+\>)([\s\-]*)"""), r"""\g<2>\g<1>""", True),
    (re.compile(r"""([\s\-]*)(\<[^\u0600-\u06FF]+\>)([\s\-]+)\r?\n"""), r"""\g<3>\g<2>\n""", True),
    (re.compile(r"""\r?\n([\s\-]+)(\<[^\u0600-\u06FF]+\>)([\s\-]*)"""), r"""\n\g<2>\g<1>""", True),
    ...
    (re.compile(r"""(\-)( *)()(\s*)(\-)"""), r"""\g<3>\g<4>\g<5>""", True),
